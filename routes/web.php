...
use App\Http\Controllers\articles\ArticlesData;
use App\Http\Controllers\company\Company;
use App\Http\Controllers\articles\ArticleDetails;
use App\Http\Controllers\events\EventsCalendar;
use App\Http\Controllers\tickets\TicketManagement;
use App\Http\Controllers\articles\ArticleManagement;
...
Route::get('/articles', [ArticlesData::class, 'index'])->name('articles');
Route::get('/company', [Company::class, 'index'])->name('company');
Route::get('/company/directory', [Company::class, 'directory'])->name('company-directory');
Route::get('/articles/details/{id}', [ArticleDetails::class, 'index'])->name('article-details');
Route::get('/events/calendar', [EventsCalendar::class, 'index'])->name('events');
Route::get('/tickets', [TicketManagement::class, 'TicketManagement'])->name('tickets');
Route::resource('/ticket-list', TicketManagement::class);
Route::resource('/article-list', ArticleManagement::class);
Route::get('/articles/founder', [ArticleManagement::class, 'ArticleManagement'])->name('articles-view');
Route::get('/table', [ArticlesData::class, 'table'])->name('table');
